"""
VOCAL SEPARATION SANITY CHECK - COMPLETE IMPLEMENTATION
========================================================

This script proves that multi-scale spectral fingerprinting can separate vocals
from a mixture WITHOUT neural network training.
...
6. ✨ OPTIMIZE mixture parameters to match vocal fingerprint (NEW)
7. ✨ RECONSTRUCT separated vocal using learned parameters (NEW)
8. ✨ Save and evaluate results (NEW)
...
CONFIG = {
    ...
    'n_fft': 2048,
    'hop_length': 1024,
    'num_iterations': 100,  # Reduced for speed
    'learning_rate': 0.01,
}
...
def process_audio_to_fingerprints(audio_path, sr, n_fft, hop_length):
    """Load audio and create complete fingerprint"""
